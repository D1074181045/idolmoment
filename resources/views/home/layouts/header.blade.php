<nav class="navbar navbar-expand-md navbar-light bg-dark-blue fixed-top" style="min-width: 400px;padding: 0;">
    <span class="navbar-logo" style="padding: 10px 1rem;"><b style="font-size: 20px;user-select: none;color: white;">偶像時刻</b></span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="navbar-collapse" style="user-select: none;padding: 0.5rem 0;">
            <lightswitch></lightswitch>
            <ul class="nav navbar-nav navbar-brand nav-t" style="margin: auto;">
                <li class="nav-item">
